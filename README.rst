...
[UPDATE March 2020] 
------------------
Yass ver. 2.0 has now been released and is available in the master branch. Please review the 
[YASS Wiki](https://github.com/paninski-lab/yass/wiki) for installation instructions on AWS and local workstations.
