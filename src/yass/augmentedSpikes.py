...
class AugmentedSpikes(object):
    ...
    """
        ...
        D: int
            number of channels away from the mainchannel. D=1 if only look at the main channel; D=2 if look at the main channel
            and its neighboring channels; D=3 if look at the main channel, the neighboring channels and the neighbors of the
    ...
    """
        Crops the big templates and keeps their main channels and neighboring channels. Main channel is defined by the channels
        ...
        templatesBig2: np.array 
            [number of templates, temporal length, number of cropped channels] cropped templates with fewer number of channels.
            All the channels of a template are ordered with respect to their distance to the main channel of that template.
        geom: np.array
